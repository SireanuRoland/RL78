/*******************************************************************************
* Library       : Flash Self-Programming Library (T01)
*
* File Name     : $Source: fsl.h $
* Lib. Version  : $RL78_FSL_LIB_VERSION_T01_IAR: V2.20 $
* Mod. Revision : $Revision: 1.13 $
* Mod. Date     : $Date: 2013/03/26 08:51:13MEZ $
* Device(s)     : RL78
* Description   : constant and function prototype definitions used by the FSL
*******************************************************************************
* DISCLAIMER
